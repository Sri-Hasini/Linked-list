    ...
    while (1) {
        ...
        switch(n) {
            ...
            case 2: cout << "Inserting at the End\n";
                    ...
                    int val1;
                    cin >> val1;
                    list1.head = list1.insert_end(list1.head, val1);
                    break;
            case 3: cout << "Inserting at a given position\n";
                    cout << "Enter position and a value to insert : ";
                    int pos, val2;
                    cin >> pos >> val2;
                    list1.head = list1.insert_position(list1.head, pos, val2);
                    break;
            case 4: cout << "Inserting before a given value\n";
                    cout << "Enter value before which it should be placed and element to insert : ";
                    int val3, el;
                    cin >> val3 >> el;
                    list1.head = list1.insert_before_value(list1.head, val3, el);
                    break;
            case 5: cout << "Deleting from the Beginning\n";
                    list1.head = list1.delete_head(list1.head);
                    break;
            case 6: cout << "Deleting from the End\n";
                    list1.head = list1.delete_end(list1.head);
                    break;
            case 7: cout << "Deleting from the given position\n";
                    cout << "Enter a position to delete : ";
                    int pos2;
                    cin >> pos2;
                    list1.head = list1.delete_position(list1.head, pos2);
                    break;
            case 8: cout << "Deleting a node with given value\n";
                    cout << "Enter a value to delete : ";
                    int val4;
                    cin >> val4;
                    list1.head = list1.delete_value(list1.head, val4);
                    break;
            case 9: cout << "Displaying linked list\n";
